(() => {
  ...
  style.textContent = `
    ...
    .sceneTools{top:92px!important;left:18px!important}.legend{left:18px!important;bottom:118px!important;border:0!important;background:rgba(7,11,16,.42)!important;backdrop-filter:blur(8px)}
