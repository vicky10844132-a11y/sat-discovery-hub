...
def main():
    ...
    try:
        ...
        assert 'SUPERVIEW NEO-1' in d.find_element(By.CSS_SELECTOR,'.hud').text
        ok('ENG-F01')

        # F02 ORBIT / NAV / GNC tabs expose only their matching engines
        ...
        # F03-F06 scene layers individually
        ...
        # F09 maneuver, F10 ADCS, F11 estimator reset
        ...
        # F12 Precision POD remains connector-required / blocked
        ...
        # F13 New Analysis invalid duration
        ...
        # F14 valid analysis updates propagation horizon; use an actually available reference-frame option
        ...
        # F17 focus/camera behavior through shared globe state
        set_select(d,'assetSelect','SUPERVIEW NEO-1')
